...
public class PDescripcionTarea extends JPanel implements ActionListener
{
    ...
    public PDescripcionTarea(VentanaMenuTareas ventanaMenuTareas, Tarea tarea) {
        ...
        this.setLayout(grid);
        JLabel titulo = new JLabel("Descripción  de "+ this.tarea.getNombre(), SwingConstants.CENTER);
